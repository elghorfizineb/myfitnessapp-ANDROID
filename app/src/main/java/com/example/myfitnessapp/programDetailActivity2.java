...
public class programDetailActivity2 extends AppCompatActivity {

    YouTubePlayerView youTubePlayerView;
    FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    DatabaseReference myRef = firebaseDatabase.getReference().child("Programs").child("program2");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(programDetailActivity2.this, program_activity.class);
        programDetailActivity2.this.finish();
        startActivity(i);
    }
}